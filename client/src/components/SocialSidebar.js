            ...
            <ul className="social-list">
                ...
                <li>
                    <a
                        ...
                        className="social-item"
                    >
                        <svg xmlns="//www.w3.org/2000/svg" role="img" viewBox="0 0 430.117 430.117">
                ...
                <li>
                    <a
                        ...
                        className="social-item"
                    >
                        <svg xmlns="//www.w3.org/2000/svg" role="img" viewBox="0 0 31.665 31.665">
                            <title>Codepen</title>
                ...
                <li>
                    <a
                        href="//twitter.com/ryanspoone"
                        target="_blank"
                        rel="nofollow noopener noreferrer"
                        aria-label="Twitter"
                        className="social-item"
                    >
                        <svg xmlns="//www.w3.org/2000/svg" role="img" viewBox="0 0 612 612">
                            <title>Twitter</title>
