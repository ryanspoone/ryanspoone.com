...
const GithubLink = props => {
    ...
    return (
        ...
        >
            <svg xmlns="//www.w3.org/2000/svg" role="img" viewBox="0 0 438.549 438.549">
                <title>GitHub</title>
...
const ExternalLink = props => {
    ...
    return (
        <a
            ...
            className="project-link"
        >
            <svg xmlns="//www.w3.org/2000/svg" role="img" viewBox="0 0 194.818 194.818">
...
export default function Projects({ error, errorCode, data, isLoading } = {}) {
    if (isLoading) {
        return (
                                    ...
                                    <div className="project-inner">
                                        ...
                                        <footer>
                                            <ul className="project-tech">
                                                {repo.repositoryTopics.map((tech, index) => (
