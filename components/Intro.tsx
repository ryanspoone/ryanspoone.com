  ...
  return (
    <section id="intro" className="intro">
      ...
      <div className="description">
        <p>
          I&apos;m a Director of Engineering turned Founder, currently based in Southeast Asia and working remotely. Over the past decade, I&apos;ve scaled engineering teams from 5 to 60+ engineers, architected data platforms processing billions of data points, and delivered products contributing $4M+ in ARR. Currently founding Ouroborai LLC, building AI-powered tools for developers.
        </p>
        <p>
